...
public class SkipExhibitTest {
    ...
    public void testSkipAllExhibits() {
        ...
        scenario.onActivity(activity -> {
            ...
            assertEquals("Directions to Flamingos", tv.getText());
            assertEquals(3, dlAdapter.getItemCount());

            skipButton.performClick();

            assertEquals(2, activity.plan.size());
            assertEquals("Directions to Capuchin Monkeys", tv.getText());
            ...
            assertEquals("Directions to Entrance and Exit Gate", tv.getText());
